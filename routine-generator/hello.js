...
for(let i=0; i<(rows-1)*columns; i++) {
 ...
 genrate.addEventListener("click",()=>{
        ...
        k++;
        pra.innerHTML=`${name_of_subject.value} with frequency ${frequency.value} added successfully`;
        list.appendChild(pra);
        name_of_subject.addEventListener("focus",()=>{
            frequency.value="";
            name_of_subject.value="";
        });
